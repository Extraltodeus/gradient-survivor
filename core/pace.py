...
PACES = [
	dict(id='slow', name='GRADIENT', tag='the long descent',
	     ...
	     events=1.00, hazard=1.00, ehp=1.00, edmg=1.00, move=1.00, cd=1.00, shake=1.00, gift=0),
	...
	dict(id='normal', name='LEARNING RATE', tag='a healthy schedule',
	     ...
	     events=1.25, hazard=1.20, ehp=1.04, edmg=1.00, move=1.125, cd=0.95, shake=1.05, gift=0),
	...
	dict(id='fast', name='OVERCLOCK', tag='fast action paced blast',
	     ...
	     events=1.70, hazard=1.55, ehp=1.16, edmg=1.05, move=1.25, cd=0.85, shake=1.15, gift=1),
	...
	dict(id='insanity', name='DIVERGENCE', tag='KABOUUUM ZWIIIING PO PO PO',
	     ...
	     events=2.60, hazard=2.20, ehp=1.38, edmg=1.15, move=1.50, cd=0.68, shake=1.30, gift=3),
]
